...
from ultralytics.utils.rodgers_visual import rodgers_visual_mask_pred
...
class BasePredictor:
    ...
    def stream_inference(self, source=None, model=None, *args, **kwargs):
        ...
        for batch in self.dataset:
            ...
            # rodgers_visual_mask_pred(preds[1:])                     ##20231030添加，预测的mask可视化

            # Postprocess
            with profilers[2]:
                self.results = self.postprocess(preds[0], im, im0s)          ##20231030添加修改
